...
router.post(
  '/:id/generate-pdf',
  requirePermission('generateFile'),
  fileController.generatePDF.bind(fileController)
);
...
router.get(
  '/:id/download',
  requirePermission('viewFiles'),
  fileController.downloadPDF.bind(fileController)
);
