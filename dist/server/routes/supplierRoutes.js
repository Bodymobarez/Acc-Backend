...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (requestData.companyName !== undefined)
            updateData.companyName = requestData.companyName;
        if (requestData.primaryContactName !== undefined)
            updateData.contactPerson = requestData.primaryContactName;
        if (requestData.primaryEmail !== undefined)
            updateData.email = requestData.primaryEmail;
        if (requestData.primaryPhone !== undefined)
            updateData.phone = requestData.primaryPhone;
        if (requestData.secondaryPhone !== undefined)
            updateData.alternatePhone = requestData.secondaryPhone;
        ...
        if (requestData.addressLine1 !== undefined)
            updateData.addressLine1 = requestData.addressLine1;
        if (requestData.addressLine2 !== undefined)
            updateData.addressLine2 = requestData.addressLine2;
        ...
        if (requestData.postalCode !== undefined)
            updateData.postalCode = requestData.postalCode;
        if (requestData.taxNumber !== undefined)
            updateData.taxNumber = requestData.taxNumber;
        if (requestData.serviceTypes !== undefined)
            updateData.serviceTypes = requestData.serviceTypes;
        if (requestData.paymentTerms !== undefined)
            updateData.paymentTerms = requestData.paymentTerms;
        if (requestData.preferredCurrency !== undefined)
            updateData.currency = requestData.preferredCurrency;
