 ...
 */
router.get('/financial/summary', requirePermission('viewFinancialReports'), reportController.getFinancialSummary.bind(reportController));
/**
 * @route   GET /api/reports/financial/revenue
 * @desc    Get revenue time series data
 * @access  Private (viewFinancialReports permission)
 */
router.get('/financial/revenue', requirePermission('viewFinancialReports'), reportController.getRevenueTimeSeries.bind(reportController));
/**
 * @route   GET /api/reports/financial/profit-loss
 * @desc    Get profit & loss statement
 * @access  Private (viewFinancialReports permission)
 */
router.get('/financial/profit-loss', requirePermission('viewFinancialReports'), reportController.getProfitLoss.bind(reportController));
/**
 * @route   GET /api/reports/financial/cash-flow
 * @desc    Get cash flow statement
 * @access  Private (viewFinancialReports permission)
 */
router.get('/financial/cash-flow', requirePermission('viewFinancialReports'), reportController.getCashFlow.bind(reportController));
/**
 * @route   GET /api/reports/financial/aging
 * @desc    Get aging report for receivables
 * @access  Private (viewFinancialReports permission)
 */
router.get('/financial/aging', requirePermission('viewFinancialReports'), reportController.getAgingReport.bind(reportController));
/**
 * @route   GET /api/reports/financial/vat
 * @desc    Get VAT report
 * @access  Private (viewVATReports permission)
 */
router.get('/financial/vat', requirePermission('viewVATReports'), reportController.getVATReport.bind(reportController));
/**
 ...
 */
router.get('/commissions', requirePermission('viewCommissionReports'), reportController.getCommissions.bind(reportController));
/**
