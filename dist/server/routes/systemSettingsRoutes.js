...
router.get('/', authenticate, requirePermission('viewSettings'), async (req, res) => {
    try {
...
// @access  Private (Admin)
router.get('/:key', authenticate, requirePermission('viewSettings'), async (req, res) => {
    try {
...
// @access  Private (Admin)
router.post('/', authenticate, requirePermission('editSettings'), [
...
// @access  Private (Admin)
router.put('/:key', authenticate, requirePermission('editSettings'), async (req, res) => {
    try {
        const { key } = req.params;
...
// @access  Private (Admin)
router.delete('/:key', authenticate, requirePermission('editSettings'), async (req, res) => {
    try {
        const { key } = req.params;
...
// @access  Private (Admin)
router.post('/bulk-update', authenticate, requirePermission('editSettings'), async (req, res) => {
    try {
        ...
        const updatePromises = settings.map((setting) => prisma.system_settings.upsert({
