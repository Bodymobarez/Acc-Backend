...
// @access  Private
router.get('/verify/booking/:bookingId/relationships', authenticate, requirePermission('viewBookings'), [param('bookingId').notEmpty().withMessage('Booking ID is required')], handleValidationErrors, async (req, res) => {
    try {
...
// @access  Private
router.get('/verify/booking/:bookingId/calculations', authenticate, requirePermission('viewBookings'), [param('bookingId').notEmpty().withMessage('Booking ID is required')], handleValidationErrors, async (req, res) => {
    try {
        const { bookingId } = req.params;
...
// @access  Private
router.get('/verify/booking/:bookingId/rates', authenticate, requirePermission('viewBookings'), [param('bookingId').notEmpty().withMessage('Booking ID is required')], handleValidationErrors, async (req, res) => {
    try {
        const { bookingId } = req.params;
...
// @access  Private
router.get('/employee/:employeeId/summary', authenticate, requirePermission('viewBookings'), [param('employeeId').notEmpty().withMessage('Employee ID is required')], handleValidationErrors, async (req, res) => {
    try {
...
router.get('/audit/all', authenticate, requirePermission('managePermissions'), async (req, res) => {
    try {
